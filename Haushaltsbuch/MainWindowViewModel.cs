...
namespace Haushaltsbuch
{
	...
	internal sealed class MainWindowViewModel : INotifyPropertyChanged
	{
		...
		/// <summary>
		/// Schnittstelle, die Tansaktionen verarbeitet (laden/speichern/löschen)
		/// </summary>
		...
		public MainWindowViewModel(MainWindow mainWindow)
		{
			...
			transactionDataAccessObject=new XmlFileTransactionDataAccessObject(fileName);
		...
		{
			Transactions = transactionDataAccessObject.GetTransactions(CreateFilter());
		}
		...
		{
			Categories = transactionDataAccessObject.GetCategoriesFromAllTransactions();
