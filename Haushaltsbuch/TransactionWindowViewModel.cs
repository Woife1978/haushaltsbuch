...
namespace Haushaltsbuch
{
	...
	internal sealed class TransactionWindowViewModel : INotifyPropertyChanged
	{
			...
			Transaction selectedTransaction)
		{
			...
			this.isEdit = isEdit;
			this.transactionDataAccessObject = new XmlFileTransactionDataAccessObject(fileName);
		...
		private void SaveEntry()
		{
			if (isEdit)
			{
				transactionDataAccessObject.DeleteTransaction( selectedTransaction);
			}

			Transaction transaction = CreateTransaction();
			transactionDataAccessObject.WriteTransaction( transaction);
		...
		{
			Descriptions = transactionDataAccessObject.GetDescriptionsFromOutgoingTransactions();
			Categories = transactionDataAccessObject.GetCategoriesFromOutgoingTransactions();
		}
		...
		{
			Descriptions = transactionDataAccessObject.GetDescriptionsFromIncomingTransactions();
			Categories = transactionDataAccessObject.GetCategoriesFromIncomingTransactions();
		}
